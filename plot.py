...
random_points = [[] for i in range(10000)]
for i in random:
    for j in i[1]:
        random_points[j[0]-1].append(j[1]-1)

qlearning_points = [[] for i in range(10000)]
for i in qlearning:
    for j in i[1]:
...
pl.fill_between(range(10000), mean_r-standard_dev_r, mean_r+standard_dev_r, alpha = 0.5)
pl.plot(mean_q, label="q-learning")
pl.fill_between(range(10000), mean_q-standard_dev_q, mean_q+standard_dev_q, alpha = 0.5)
